...
\newtcolorbox[use counter=theorem]{thmbox}[2][]{label type=theorem,title=Theorem~\thetcbcounter: #2,#1}
\newtcolorbox[use counter=theorem]{corbox}[2][]{label type=corollary,title=Corollary~\thetcbcounter: #2,#1}
