...
$A_1, \dots, A_n$ are measurable sets with finite measure.

\[
\#A &\eqdef \text{number of $A_i$ which occur} \\
\mu[\#A \ge 1] &= \sum_{\substack{I \subset [n] \\ 1 \le |I|}} (-1)^{|I|+1} \mu\left(\bigcap_{i \in I} A_i\right) \\
...
\begin{proof}
  ...
  \end{itemize}
  Integrating completes the proof.
\end{proof}
}
